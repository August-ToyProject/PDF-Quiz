...
async def create_prompt_template():
    try:
        return PromptTemplate.from_template(
            ...
            2. 정답 보기는 동일문제를 참고해서 균등하게 1번과 2번과 같이 한쪽으로 치우치지 않도록 만들어주세요.
            3. 난이도가 올라갈수록 키워드를 여러개 조합해서 문제를 만들어주세요 쉬움 : 1개 , 중간 2~3개, 어려움 4~5개.
            4. 절대로 동일문제와 비슷하거나 똑같은 문제는 생성하지 마세요.
            5. {used_keywords}로는 문제를 생성하지 마세요.
            6. 문제 보기는 1~{choice_count}까지 다양하게 해주세요:
            ...
            난이도: 쉬움
            문제: 인공지능(AI)의 주요 목표 중 옳지 않은 것은 무엇인가요?
            1) 인간의 지능을 모방하고 인간과 유사한 방식으로 문제를 해결하는 것
            2) 최대한 많은 데이터를 수집하는 것
            3) 가장 빠른 컴퓨터를 만드는 것
            정답: 3
            설명: AI의 목표는 컴퓨터의 속도를 빠르게 하는 것이 아니라, 인간의 지능을 모방하여 문제를 해결하는 것입니다.
            ...
            난이도: 어려움
            문제: 딥러닝과 일반적인 머신러닝의 차이점으로 옳지 않은 것은 무엇인가요?
            1) 딥러닝은 다층 신경망을 사용하여 복잡한 패턴을 학습할 수 있다
            2) 딥러닝은 단일 신경망으로만 학습이 가능하다
            3) 딥러닝은 자동으로 데이터의 중요한 특징을 추출할 수 있다
            4) 딥러닝은 대규모 데이터에서 더 좋은 성능을 낼 수 있다
            5) 딥러닝은 다양한 학습 기법을 활용할 수 있다
            정답: 2
            설명: 딥러닝은 단일 신경망이 아닌 다층 신경망을 사용하여 복잡한 패턴을 학습합니다.
